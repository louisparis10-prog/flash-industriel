...
const STATUT_LEGENDS = {
  ...
  statut_global:        { vert: ['Conforme',            'Tous équipements opérationnels'],   orange: ['Dégradé',          'Un ou plusieurs équipements en anomalie'], rouge: ['Critique',     'Équipement vital en panne']             },
